...
public class ForecastFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //So that it handles menu events
    ...
    public class FetchWeatherTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=Madison,us&mode=json&units=metric&cnt=7&APPID=2d982636a357376c309d796d7c11423a");
                ...
                //Display outputs of returned String from query to debugger
                Log.d("QUERY RETURN STRING:", forecastJsonStr);
